<?php
// finance/profile.php - Finance Officer Profile Management
session_start();
...
// Get user statistics for finance officer
$stats_query = "SELECT 
    ...
    (SELECT COUNT(*) FROM payments WHERE DATE(paid_at) = CURDATE()) as today_payments,
...
<div class="profile-container">
    ...
    <div class="flex items-center gap-3 mb-4">
        <a href="dashboard.php" class="p-1 hover:bg-surface-container-low rounded-lg transition">
            <span class="material-symbols-outlined">arrow_back</span>
        </a>
        <div>
            <h2 class="font-headline-lg text-on-background text-xl font-bold">Akaunti Yangu</h2>
            <p class="text-secondary text-xs mt-0.5">Simamia taarifa zako za akaunti na mipangilio</p>
        </div>
    </div>
        ...
        <div class="md:col-span-1">
            <div class="profile-sidebar">
                <div class="profile-avatar">
                    ...
                    <div class="profile-role">Afisa Fedha (Finance Officer)</div>
                </div>
            ...
            <div class="stats-grid mt-3">
                ...
                <div class="stat-card">
                    <div class="stat-number">TZS <?php echo number_format($stats['total_amount'] ?? 0, 0, '.', ','); ?></div>
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-label">Shughuli</div>
                </div>
            </div>
        </div>
        ...
        <div class="md:col-span-2">
            ...
            <div class="profile-tabs">
                <a href="?tab=profile" class="profile-tab <?php echo $active_tab === 'profile' ? 'active' : ''; ?>">
                    <span class="material-symbols-outlined" style="font-size: 0.9rem;">account_circle</span> Taarifa za Akaunti
                </a>
                <a href="?tab=security" class="profile-tab <?php echo $active_tab === 'security' ? 'active' : ''; ?>">
                    <span class="material-symbols-outlined" style="font-size: 0.9rem;">lock</span> Usalama
                </a>
                <a href="?tab=notifications" class="profile-tab <?php echo $active_tab === 'notifications' ? 'active' : ''; ?>">
                    <span class="material-symbols-outlined" style="font-size: 0.9rem;">notifications</span> Arifa
                </a>
                <a href="?tab=activities" class="profile-tab <?php echo $active_tab === 'activities' ? 'active' : ''; ?>">
                    <span class="material-symbols-outlined" style="font-size: 0.9rem;">history</span> Shughuli Zangu
                </a>
            </div>
                    ...
                    <form method="POST" action="">
                        ...
                        <div class="space-y-3">
                            <div class="flex items-center justify-between py-2 border-b border-outline-variant">
                                <div>
                                    <div class="font-medium text-sm">Arifa kwa Barua Pepe</div>
                                    <div class="text-xs text-secondary">Pokea arifa kuhusu malipo na taarifa za mfumo</div>
                                </div>
                            ...
                            <div class="flex items-center justify-between py-2 border-b border-outline-variant">
                                <div>
                                    <div class="font-medium text-sm">Arifa kwa SMS</div>
                ...
                <div class="settings-card-body p-0">
                    <div class="activity-list">
                        ...
                        <div class="text-center py-6 text-secondary">
                            <span class="material-symbols-outlined text-3xl mb-1 block">history</span>
                            ...
                            <div class="activity-icon">
                                <span class="material-symbols-outlined">
                                    ...
                                    $icons = [
                                        ...
                                        'LOGIN' => 'login',
                                        'LOGOUT' => 'logout',
                                        'BULK_UPDATE_PAYMENTS' => 'select_all',
                                    ];
