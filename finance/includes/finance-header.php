<?php
// finance/includes/finance-header.php - Finance Officer Header Component
...
<title><?php echo $page_title ?? 'Finance Dashboard'; ?> | HCS - House Compensation System</title>
...
require_once __DIR__ . '/finance-sidebar.php';
?>

<!-- Main Content Area -->
<div class="flex-1 flex flex-col h-full overflow-hidden">
    
    <!-- Finance Header (Top Navigation) -->
    <header class="flex items-center justify-between px-md md:px-lg h-16 bg-surface-container-lowest border-b border-outline-variant shrink-0 z-30">
        <div class="flex items-center gap-md">
            ...
            <h1 class="font-headline-md text-primary font-bold truncate"><?php echo $page_heading ?? 'Finance Dashboard'; ?></h1>
        </div>
        ...
        <div class="flex items-center gap-md">
            ...
            <div class="relative">
                ...
                <div id="userMenu" class="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg border border-outline-variant hidden z-50">
                    ...
                    <a href="payments.php" class="flex items-center gap-2 px-4 py-2 text-sm hover:bg-surface-container-low">
