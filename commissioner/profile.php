<?php
// commissioner/profile.php - Commissioner Profile Management
session_start();
...
// Get user statistics (commissioner specific)
$stats_query = "SELECT 
    (SELECT COUNT(*) FROM claims) as total_claims,
    (SELECT COUNT(*) FROM claims WHERE status = 'submitted') as pending_claims,
    ...
    (SELECT COUNT(*) FROM help_requests WHERE status = 'pending') as pending_help_requests";
...
// Use commissioner header instead of claimant header
...
<div class="profile-container">
    ...
    <div class="flex items-center gap-3 mb-6">
        <a href="dashboard.php" class="p-2 hover:bg-surface-container-low rounded-lg transition" style="text-decoration: none; color: #3d4a3d;">
            <span class="material-symbols-outlined">arrow_back</span>
        </a>
        <div>
            <h2 class="text-2xl font-bold" style="color: #1e2a1e;">Akaunti Yangu</h2>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div class="md:col-span-1">
            <div class="profile-sidebar">
                <div class="profile-avatar">
                    ...
                    <div class="profile-role">
                        <?php 
                        $role_labels = [
                            'commissioner' => 'Kamishna (Commissioner)',
                            'super_admin' => 'Msimamizi Mkuu (Super Admin)'
                        ];
            ...
            <div class="stats-grid">
                ...
                <div class="stat-card">
                    <div class="stat-number"><?php echo number_format($stats['pending_claims'] ?? 0); ?></div>
                    <div class="stat-label">Madai Yanayosubiri</div>
                </div>
                <div class="stat-card">
                    <div class="stat-number"><?php echo number_format($stats['total_payments'] ?? 0); ?></div>
                    <div class="stat-label">Malipo Yaliyofanywa</div>
                </div>
                <div class="stat-card">
                    <div class="stat-number"><?php echo number_format($stats['total_documents'] ?? 0); ?></div>
                    <div class="stat-label">Nyaraka Zote</div>
                </div>
                <div class="stat-card">
                ...
                <div class="stat-card">
                    <div class="stat-number"><?php echo number_format($stats['pending_help_requests'] ?? 0); ?></div>
                    <div class="stat-label">Maombi ya Msaada</div>
                </div>
            </div>
        </div>
        ...
        <div class="md:col-span-2">
            ...
            <div class="settings-card" style="background: #d1fae5; border-color: #a7f3d0; margin-bottom: 1rem;">
                <div class="settings-card-body" style="color: #065f46;">
            ...
            <div class="settings-card" style="background: #fee2e2; border-color: #fecaca; margin-bottom: 1rem;">
                <div class="settings-card-body" style="color: #991b1b;">
                    <div class="flex items-center gap-2">
            ...
            <div class="settings-card">
                <div class="settings-card-header">
                    <h3>
                        <span class="material-symbols-outlined" style="color: #006e2c;">edit</span>
            ...
            <div class="settings-card">
                <div class="settings-card-header">
                    <h3>
                        <span class="material-symbols-outlined" style="color: #006e2c;">lock</span>
                        Badilisha Nenosiri
                    </h3>
                </div>
                <div class="settings-card-body">
            ...
            <div class="settings-card">
                <div class="settings-card-header">
                    <h3>
                        <span class="material-symbols-outlined" style="color: #006e2c;">notifications</span>
                        Mipangilio ya Arifa
                    </h3>
                </div>
                <div class="settings-card-body">
            ...
            <div class="settings-card">
                <div class="settings-card-header">
                    <h3>
                        <span class="material-symbols-outlined" style="color: #006e2c;">history</span>
                ...
                <div class="settings-card-body p-0">
                    <div class="activity-list">
                        ...
                        <div class="text-center py-8 text-secondary">
                            <span class="material-symbols-outlined" style="font-size: 2.5rem; display: block; margin-bottom: 0.5rem;">history</span>
...
mysqli_close($conn);
require_once __DIR__ . '/includes/commissioner-footer.php'; 
?>