<?php
// commissioner/includes/commissioner-sidebar.php - Commissioner Sidebar Component with Dropdown Menus

// Determine current page for active states
$current_page = basename($_SERVER['PHP_SELF']);
?>

<!-- Commissioner Sidebar (Desktop & Mobile Drawer) -->
<aside class="fixed inset-y-0 left-0 w-72 bg-surface-container-lowest border-r border-outline-variant z-50 transform -translate-x-full transition-transform duration-300 ease-in-out md:relative md:translate-x-0 flex flex-col h-full overflow-y-auto custom-scrollbar" id="sidebar">
    ...
    <div class="px-md py-4 mb-2 flex items-center justify-between border-b border-outline-variant shrink-0 bg-surface-container-lowest">
        <a href="dashboard.php" class="flex items-center gap-2">
            ...
            <span class="font-headline-md text-primary font-bold">HCS | Commissioner</span>
        </a>
    ...
    <div class="flex-1 px-3 py-2">
        ...
        <div class="flex items-center gap-3 p-3 bg-surface-container-low rounded-xl mb-4">
            ...
            <div class="flex-1 min-w-0">
                <p class="font-label-md text-on-surface truncate font-semibold"><?php echo htmlspecialchars($_SESSION['full_name'] ?? 'Commissioner'); ?></p>
                <p class="text-[11px] text-secondary">Kamishna (Commissioner)</p>
            </div>
        </div>
        ...
        <div class="space-y-1">
            ...
            <div class="dropdown-container <?php echo $is_reports_active ? 'dropdown-open' : ''; ?>">
                ...
                <div class="dropdown-content pl-11 flex flex-col gap-1 mt-1 ml-2 border-l-2 border-outline-variant">
                    ...
                    <a href="reports.php?type=claims" class="py-2.5 text-sm text-secondary hover:text-primary hover:bg-primary-container/10 rounded-lg px-3 transition-all duration-200">
                        📋 Ripoti za Madai
                    </a>
                    <a href="reports.php?type=payments" class="py-2.5 text-sm text-secondary hover:text-primary hover:bg-primary-container/10 rounded-lg px-3 transition-all duration-200">
                        💰 Ripoti za Malipo
                    </a>
                    <a href="reports.php?type=financial" class="py-2.5 text-sm text-secondary hover:text-primary hover:bg-primary-container/10 rounded-lg px-3 transition-all duration-200">
                        📈 Ripoti za Kifedha
                    </a>
                </div>
            </div>
            ...
            ?>
            <div class="dropdown-container <?php echo $is_claims_active ? 'dropdown-open' : ''; ?>">
                <button class="w-full flex items-center justify-between px-3 py-2.5 <?php echo $is_claims_active ? 'bg-secondary-container text-on-secondary-container font-semibold' : 'text-secondary hover:bg-surface-container-high'; ?> rounded-xl transition-all duration-200" onclick="toggleDropdown(this)">
                    <div class="flex items-center gap-3">
                ...
                <div class="dropdown-content pl-11 flex flex-col gap-1 mt-1 ml-2 border-l-2 border-outline-variant">
                    <a href="claims.php" class="py-2.5 text-sm <?php echo $is_claims_active ? 'text-primary font-semibold bg-primary-container/15 rounded-lg px-3' : 'text-secondary hover:text-primary hover:bg-primary-container/10 rounded-lg px-3'; ?> transition-all duration-200">
                        📋 Madai Yote
                    </a>
                    <a href="claims.php?status=submitted" class="py-2.5 text-sm flex items-center gap-2 text-secondary hover:text-primary hover:bg-primary-container/10 rounded-lg px-3 transition-all duration-200">
                        <span class="w-2 h-2 bg-purple-500 rounded-full"></span> Yaliyowasilishwa
                    </a>
                    <a href="claims.php?status=valuation" class="py-2.5 text-sm flex items-center gap-2 text-secondary hover:text-primary hover:bg-primary-container/10 rounded-lg px-3 transition-all duration-200">
                        <span class="w-2 h-2 bg-orange-500 rounded-full"></span> Katika Tathmini
                    </a>
                    <a href="claims.php?status=legal_review" class="py-2.5 text-sm flex items-center gap-2 text-secondary hover:text-primary hover:bg-primary-container/10 rounded-lg px-3 transition-all duration-200">
                        <span class="w-2 h-2 bg-cyan-500 rounded-full"></span> Uhakiki wa Kisheria
                    </a>
                    <a href="claims.php?status=approved" class="py-2.5 text-sm flex items-center gap-2 text-secondary hover:text-primary hover:bg-primary-container/10 rounded-lg px-3 transition-all duration-200">
                        <span class="w-2 h-2 bg-green-500 rounded-full"></span> Yaliyoidhinishwa
                    </a>
                    <a href="claims.php?status=rejected" class="py-2.5 text-sm flex items-center gap-2 text-secondary hover:text-primary hover:bg-primary-container/10 rounded-lg px-3 transition-all duration-200">
                        <span class="w-2 h-2 bg-red-500 rounded-full"></span> Yaliyokataliwa
                    </a>
                    <a href="claims.php?status=paid" class="py-2.5 text-sm flex items-center gap-2 text-secondary hover:text-primary hover:bg-primary-container/10 rounded-lg px-3 transition-all duration-200">
                        <span class="w-2 h-2 bg-emerald-500 rounded-full"></span> Yaliyolipwa
                    </a>
                </div>
            </div>
            ...
            <div class="dropdown-container <?php echo $is_payments_active ? 'dropdown-open' : ''; ?>">
                ...
                <div class="dropdown-content pl-11 flex flex-col gap-1 mt-1 ml-2 border-l-2 border-outline-variant">
                    <a href="payments.php" class="py-2.5 text-sm <?php echo $is_payments_active ? 'text-primary font-semibold bg-primary-container/15 rounded-lg px-3' : 'text-secondary hover:text-primary hover:bg-primary-container/10 rounded-lg px-3'; ?> transition-all duration-200">
                        💰 Malipo Yote
                    </a>
                    <a href="payments.php?status=completed" class="py-2.5 text-sm flex items-center gap-2 text-secondary hover:text-primary hover:bg-primary-container/10 rounded-lg px-3 transition-all duration-200">
                        <span class="w-2 h-2 bg-green-500 rounded-full"></span> Malipo Yaliyokamilika
                    </a>
                    <a href="payments.php?status=pending" class="py-2.5 text-sm flex items-center gap-2 text-secondary hover:text-primary hover:bg-primary-container/10 rounded-lg px-3 transition-all duration-200">
                        <span class="w-2 h-2 bg-yellow-500 rounded-full"></span> Malipo Yanayosubiri
                    </a>
                </div>
            </div>
            ...
            <div class="dropdown-container <?php echo $is_valuations_active ? 'dropdown-open' : ''; ?>">
                ...
                <div class="dropdown-content pl-11 flex flex-col gap-1 mt-1 ml-2 border-l-2 border-outline-variant">
                    <a href="valuations.php" class="py-2.5 text-sm <?php echo $is_valuations_active ? 'text-primary font-semibold bg-primary-container/15 rounded-lg px-3' : 'text-secondary hover:text-primary hover:bg-primary-container/10 rounded-lg px-3'; ?> transition-all duration-200">
                        📊 Tathmini Zote
                    </a>
                </div>
            </div>
