<?php
// commissioner/includes/commissioner-footer.php - Commissioner Footer Component
?>

    </main>
    
    <!-- Commissioner Footer (Desktop) -->
    <footer class="hidden md:block bg-surface-container-high py-3 border-t border-outline-variant shrink-0">
    ...
    <nav class="bottom-nav fixed bottom-0 left-0 right-0 bg-white border-t border-outline-variant flex md:hidden items-center justify-around px-2 py-1 shadow-lg z-50" style="padding-bottom: env(safe-area-inset-bottom, 0.5rem);">
        ...
        <a href="reports.php" class="bottom-nav-item flex flex-col items-center justify-center py-1 px-3 rounded-lg active:bg-surface-container transition-all">
            <span class="material-symbols-outlined text-on-surface-variant text-2xl">analytics</span>
            <span class="font-label-sm text-label-sm text-on-surface-variant text-xs">Ripoti</span>
        </a>
        
        <div class="-mt-8">
            <a href="claims.php" class="w-14 h-14 bg-primary text-white rounded-full shadow-lg flex items-center justify-center active:scale-95 transition-transform">
