<?php
// commissioner/includes/commissioner-header.php - Commissioner Header Component
...
<title><?php echo $page_title ?? 'Commissioner Dashboard'; ?> | HCS - House Compensation System</title>
...
<?php
// Include commissioner sidebar
require_once __DIR__ . '/commissioner-sidebar.php';
?>

<!-- Main Content Area -->
<div class="main-content-area flex-1">
    
    <!-- Commissioner Header (Top Navigation) -->
    <header class="flex items-center justify-between px-md md:px-lg h-16 bg-surface-container-lowest border-b border-outline-variant shrink-0 z-30">
        <div class="flex items-center gap-md">
            ...
            <h1 class="font-headline-md text-primary font-bold truncate"><?php echo $page_heading ?? 'Commissioner Dashboard'; ?></h1>
        </div>
        ...
        <div class="flex items-center gap-md">
            ...
            <div class="relative">
                ...
                <div id="userMenu" class="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg border border-outline-variant hidden z-50">
                    ...
                    <a href="reports.php" class="flex items-center gap-2 px-4 py-2 text-sm hover:bg-surface-container-low">
