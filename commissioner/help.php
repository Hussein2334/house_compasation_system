<?php
// commissioner/help.php - Help & Support Page
session_start();
...
// Include header - use commissioner-header.php since this is commissioner panel
...
<div class="help-container">
    ...
    <div class="faq-section">
        <div class="faq-header">
            <h3>
                <span class="material-symbols-outlined" style="color: #006e2c;">help</span>
    ...
    <div class="contact-section" id="contactForm">
        <div class="contact-header">
            <h3>
                <span class="material-symbols-outlined" style="color: #006e2c;">contact_support</span>
                Wasiliana Nasi
            </h3>
        </div>
            ...
            <form method="POST" action="" id="helpForm">
                ...
                <div class="grid-2">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" class="form-input" value="<?php echo htmlspecialchars($_SESSION['email']); ?>" readonly disabled style="background-color: #f4fcef;">
                    </div>
                </div>
                <div class="form-group">
    ...
    <div class="bg-white border rounded-lg p-4 text-center">
        <div class="flex items-center justify-center gap-2 mb-2">
            <span class="material-symbols-outlined" style="color: #006e2c;">schedule</span>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (firstFaq) {
            ...
            const icon = firstFaq.querySelector('.faq-question .material-symbols-outlined:last-child');
            if (icon) {
                icon.textContent = 'expand_less';
            }
        }
    ...
    // Form validation without SweetAlert (use native confirm)
    ...
    if (helpForm) {
        helpForm.addEventListener('submit', function(e) {
            ...
            if (!subject) {
                e.preventDefault();
                alert('Tafadhali jaza mada ya msaada');
                return false;
            }
            
            if (!category) {
                e.preventDefault();
                alert('Tafadhali chagua aina ya msaada');
                return false;
            }
            
            if (!message || message.length < 10) {
                e.preventDefault();
                alert('Tafadhali jaza ujumbe wako (angalau herufi 10)');
                return false;
            }
            
            // Show confirmation
            if (!confirm('Je, una uhakika unataka kutuma ombi hili la msaada?')) {
                e.preventDefault();
                return false;
            }
        });
