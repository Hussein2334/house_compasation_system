<?php
// legal/includes/legal-footer.php - Legal Officer Footer Component
?>
    ...
    <nav class="bottom-nav fixed bottom-0 left-0 right-0 bg-white border-t border-outline-variant flex md:hidden items-center justify-around px-2 py-1 shadow-lg z-50" style="padding-bottom: env(safe-area-inset-bottom, 0.5rem);">
        ...
        <div class="-mt-8">
            <a href="claims.php?status=legal_review" class="w-14 h-14 bg-primary text-white rounded-full shadow-lg flex items-center justify-center active:scale-95 transition-transform">
