<?php
// legal/profile.php - Legal Officer Profile Management
session_start();
...
// Get user statistics for legal officer
$stats_query = "SELECT 
    (SELECT COUNT(*) FROM claims WHERE status IN ('legal_review', 'approved', 'rejected')) as total_claims,
    (SELECT COUNT(*) FROM claims WHERE status = 'legal_review') as pending_claims,
    ...
    (SELECT COUNT(*) FROM approvals WHERE approval_stage = 'legal_review' AND approved_by = ?) as my_approvals,
    (SELECT COUNT(*) FROM documents d JOIN claims c ON d.claim_id = c.id WHERE c.status = 'legal_review') as pending_docs";
        ...
        <div class="md:col-span-1">
            <div class="profile-sidebar">
                <div class="profile-avatar">
                    ...
                    <div class="profile-role">Afisa Kisheria (Legal Officer)</div>
                </div>
            ...
            <div class="stats-grid mt-4">
                ...
                <div class="stat-card">
                    <div class="stat-number"><?php echo number_format($stats['my_approvals'] ?? 0); ?></div>
                    <div class="stat-label">Uamuzi Wangu</div>
                </div>
            </div>
        </div>
                        ...
                        <div class="space-y-4">
                            <div class="flex items-center justify-between py-2 border-b border-outline-variant">
                                <div>
                                    ...
                                    <div class="text-xs text-secondary">Pokea arifa kuhusu madai na tathmini</div>
                                </div>
                            ...
                            <div class="activity-icon">
                                <span class="material-symbols-outlined">
                                    ...
                                    $icons = [
                                        ...
                                        'UPDATE_NOTIFICATION_SETTINGS' => 'notifications',
                                    ];
