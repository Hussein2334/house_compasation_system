<?php
// legal/help.php - Legal Officer Help & Support
session_start();
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit_help'])) {
    ...
    if (empty($errors)) {
        ...
        if (mysqli_stmt_execute($stmt)) {
            ...
            if ($admin) {
                $notif_title = "Ombi Jipya la Msaada kutoka Afisa Kisheria";
                $notif_message = "Afisa Kisheria $full_name ametuma ombi la msaada: $subject";
...
<div class="help-container">
    ...
    <div class="hero-section">
        ...
        <div class="hero-subtitle">Tuko hapa kukusaidia kwa maswali yako yote kuhusu uhakiki wa madai, nyaraka na mfumo</div>
    </div>
    ...
    <div class="help-grid">
        <div class="help-card" onclick="scrollToForm('legal')">
            <div class="help-card-icon">
                <span class="material-symbols-outlined">gavel</span>
            </div>
            <div class="help-card-title">Maswali kuhusu Uhakiki wa Madai</div>
            <div class="help-card-desc">Msaada kuhusu usindikaji wa madai na uamuzi wa kisheria</div>
        </div>
        <div class="help-card" onclick="scrollToForm('documents')">
            <div class="help-card-icon">
                <span class="material-symbols-outlined">description</span>
            </div>
            <div class="help-card-title">Maswali kuhusu Nyaraka</div>
            <div class="help-card-desc">Msaada kuhusu upakiaji na uhakiki wa nyaraka</div>
        </div>
    ...
    <div class="faq-section">
        <div class="faq-header">
            <h3>
                ...
                Maswali Yanayoulizwa Sana (FAQ) kwa Wahakiki wa Kisheria
            </h3>
        </div>
        
        <div class="faq-item">
            <div class="faq-question" onclick="toggleFaq(this)">
                <span class="faq-question-text">⚖️ Je, ninawezaje kukagua dai lililowasilishwa?</span>
                <span class="material-symbols-outlined">expand_more</span>
            </div>
            <div class="faq-answer">
                <div class="faq-answer-content">
                    Nenda kwenye ukurasa wa "Usimamizi wa Madai", utaona madai yote yaliyo katika hali ya "Yanayosubiri Uhakiki". Bonyeza kwenye dai la mwombaji kwa taarifa kamili, ukagua tathmini, na uamue kuidhinisha au kukataa.
                </div>
            </div>
        </div>
        ...
        <div class="faq-item">
            <div class="faq-question" onclick="toggleFaq(this)">
                <span class="faq-question-text">📋 Je, ni vigezo gani vya kuidhinisha dai?</span>
                <span class="material-symbols-outlined">expand_more</span>
            </div>
            <div class="faq-answer">
                <div class="faq-answer-content">
                    Dai linaweza kuidhinishwa ikiwa tathmini imefanywa kwa usahihi, nyaraka zote zinahitajika zimewasilishwa, na kiasi cha fidia kinaendana na kanuni za serikali. Hakikisha umeangalia thamani ya mali, posho za usumbufu na usafiri.
                </div>
            </div>
        </div>
        ...
        <div class="faq-item">
            <div class="faq-question" onclick="toggleFaq(this)">
                <span class="faq-question-text">📄 Je, nahitaji kuangalia nyaraka zipi kabla ya kuidhinisha dai?</span>
                <span class="material-symbols-outlined">expand_more</span>
            </div>
            <div class="faq-answer">
                <div class="faq-answer-content">
                    Unahitaji kuhakikisha mwombaji amewasilisha: Hati ya umiliki wa ardhi, kitambulisho cha mwombaji, ripoti ya tathmini ya mkaguzi, na nyaraka nyingine za usaidizi kama nyaraka za usumbufu.
                </div>
            </div>
        </div>
        ...
        <div class="faq-item">
            <div class="faq-question" onclick="toggleFaq(this)">
                <span class="faq-question-text">✏️ Je, ninaweza kuhariri taarifa za dai kabla ya kukidhinisha?</span>
                <span class="material-symbols-outlined">expand_more</span>
            </div>
            <div class="faq-answer">
                <div class="faq-answer-content">
                    Ndiyo, unaweza kuhariri taarifa za dai na tathmini kabla ya kukidhinisha. Bonyeza kwenye ikoni ya "Hariri" kwenye jedwali la madai, kisha badilisha taarifa zinazohitajika na uhifadhi.
                </div>
            </div>
        </div>
        ...
        <div class="faq-item">
            <div class="faq-question" onclick="toggleFaq(this)">
                <span class="faq-question-text">📊 Je, ninaweza kuona ripoti za madai niliyokagua?</span>
                <span class="material-symbols-outlined">expand_more</span>
            </div>
            <div class="faq-answer">
                <div class="faq-answer-content">
                    Unaweza kuona ripoti za madai kwa kwenda kwenye "Ripoti" → "Ripoti za Uhakiki". Unaweza kuchuja kwa tarehe, hali ya dai, na kiasi cha fidia.
                </div>
            </div>
        </div>
        ...
        <div class="faq-item">
            <div class="faq-question" onclick="toggleFaq(this)">
                <span class="faq-question-text">📧 Je, mwombaji anapata taarifa baada ya uamuzi wangu?</span>
                <span class="material-symbols-outlined">expand_more</span>
            </div>
            <div class="faq-answer">
                <div class="faq-answer-content">
                    Ndiyo, mfumo unatuma arifa kwa mwombaji kwa barua pepe na SMS (kama amewasha) baada ya uamuzi wako. Arifa itaonyesha kama dai limeidhinishwa au kukataliwa pamoja na sababu zake.
                </div>
            </div>
        </div>
        ...
        <div class="faq-item">
            <div class="faq-question" onclick="toggleFaq(this)">
                <span class="faq-question-text">🔄 Je, dai lililokataliwa linaweza kutolewa tena?</span>
                <span class="material-symbols-outlined">expand_more</span>
            </div>
            <div class="faq-answer">
                <div class="faq-answer-content">
                    Ndiyo, mwombaji anaweza kuwasilisha dai upya baada ya kurekebisha kasoro zilizoainishwa kwenye uamuzi wako wa kukataa. Anahitaji kuwasilisha nyaraka au taarifa mpya.
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="contact-body">
            ...
            <div class="contact-info-grid">
                ...
                <div class="contact-info-card">
                    ...
                    <div class="value">legal@hcs.go.tz</div>
            ...
            <form method="POST" action="" id="helpForm">
                ...
                <div class="grid-2">
                    <div class="form-group">
                        ...
                        <input type="text" name="subject" class="form-input" required placeholder="Mfano: Swali kuhusu uhakiki wa dai">
                    </div>
                    <div class="form-group">
                        <label class="form-label required">Aina ya Msaada</label>
                        <select name="category" class="form-select" required>
                            <option value="">-- Chagua Aina --</option>
                            <option value="legal">Uhakiki wa Madai</option>
                            <option value="documents">Nyaraka</option>
    ...
    <!-- Quick Tips for Legal Officers -->
    <div class="bg-green-50 border border-green-200 rounded-lg p-3 mt-3">
        <div class="flex items-start gap-2">
            <span class="material-symbols-outlined text-green-600 text-sm">tips_and_updates</span>
            <div>
                <p class="text-sm font-semibold text-green-800">Vidokezo kwa Wahakiki wa Kisheria</p>
                <ul class="text-xs text-green-700 mt-1 space-y-1 list-disc list-inside">
                    <li>Kagua tathmini kwa makini kabla ya kuidhinisha dai</li>
                    <li>Hakikisha nyaraka zote muhimu zimewasilishwa na ni halali</li>
                    <li>Thibitisha kwamba kiasi cha fidia kinaendana na kanuni za serikali</li>
                    <li>Weka maelezo ya kina kwenye sababu za kukataa dai</li>
                    <li>Wasiliana na idara ya tathmini kama kuna maswali kuhusu ukaguzi</li>
                    <li>Kagua ripoti za madai mara kwa mara ili kufuatilia maendeleo</li>
                </ul>
            </div>
        </div>
    </div>
