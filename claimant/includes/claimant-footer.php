<?php
// claimant/includes/claimant-footer.php - Claimant Footer Component
?>

    </main>
    
    <!-- Claimant Footer (Desktop) -->
    ...
    <nav class="bottom-nav fixed bottom-0 left-0 right-0 bg-white border-t border-outline-variant flex md:hidden items-center justify-around px-2 py-1 shadow-lg z-50" style="padding-bottom: env(safe-area-inset-bottom, 0.5rem);">
        ...
        <a href="my-claims.php" class="bottom-nav-item flex flex-col items-center justify-center py-1 px-3 rounded-lg active:bg-surface-container transition-all">
        ...
        <div class="-mt-8">
            <a href="submit-claim.php" class="w-14 h-14 bg-primary text-white rounded-full shadow-lg flex items-center justify-center active:scale-95 transition-transform">
                <span class="material-symbols-outlined text-3xl">add</span>
            </a>
        </div>
        
        <a href="my-payments.php" class="bottom-nav-item flex flex-col items-center justify-center py-1 px-3 rounded-lg active:bg-surface-container transition-all">
